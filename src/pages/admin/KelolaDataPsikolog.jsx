...
const Pembayaran = () => {
  ...
  const roundBackgroundStyleUbah = {
                ...
                <table class="mt-5 table table-bordered text-center" style={{backgroundColor: 'transparent' }}>
                  <thead>
                    <tr>
                      ...
                      <th scope="col" style={{ width: '100px' }}>Sertifikat <ArrowIcon></ArrowIcon></th>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <div style={roundBackgroundStyleContainer}>
                          <button style={roundBackgroundStyleUbah}> 
                            <b> Ubah </b>
                          </button>
