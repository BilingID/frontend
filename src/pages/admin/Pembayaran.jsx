...
const Pembayaran = () => {
  ...
  const initialData = [
    { code: '#111111111', name: 'AAAAAAA', date: '10/6/2020', price: 'Rp. 50.000', status: 'Berhasil' },
    { code: '#222222222', name: 'BBBBBBB', date: '10/6/2021', price: 'Rp. 150.000', status: 'Pending' },
    { code: '#333333333', name: 'CCCCCCC', date: '10/6/2022', price: 'Rp. 250.000', status: 'Berhasil' },
    { code: '#444444444', name: 'DDDDDDD', date: '10/6/2023', price: 'Rp. 300.000', status: 'Pending' },
    { code: '#555555555', name: 'EEEEEEE', date: '10/6/2024', price: 'Rp. 450.000', status: 'Berhasil' },
    { code: '#666666666', name: 'FFFFFFF', date: '10/6/2025', price: 'Rp. 550.000', status: 'Pending' },
  ];
    ...
    <div className='container-fluid' style={{backgroundColor: '#ffffff'}}>
        ...
        <Row className="pt-3 ms-3 me-3">
            ...
            <button className={`rounded-corner pt-3 ${activeButton === 'customer' ? 'bg-primary text-white' : 'bg-transparent'}`} style={{ border: '1px solid white', width: '200px' }}>
              ...
              <button className={`rounded-corner pt-3`} style={{ marginTop: '350px', border: '1px solid white', width: '200px',backgroundColor: 'white' }}>
            ...
            <div>
              <div className="d-flex align-items-center">
                ...
                <button className="btn ms-5"><SearchIcon></SearchIcon></button>
                <button className="btn ms-5"><RingIcon></RingIcon></button>
              </div>
              <div className='mt-5'>
                    {selectedItem && (
                  <div>
